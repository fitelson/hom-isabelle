...
in the \href{https://github.com/fitelson/bacon-dorr-isabelle/tree/main/Applications/goodman-isabelle}{Goodman application folder},
with the background logic supplied by
the \href{https://github.com/fitelson/bacon-dorr-isabelle}{Bacon--Dorr core repository}
\cite{book,classic}.
...
Bacon's stated action-compatibility condition. More general core completeness
questions are documented in the core's own source guide.
