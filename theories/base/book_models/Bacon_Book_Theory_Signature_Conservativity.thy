theory Bacon_Book_Theory_Signature_Conservativity
  imports Bacon_Book_Theory_Retraction Bacon_Book_Theory_Signature_Monotonicity
begin
...
theorem book_theory_foreign_constants_eliminate:
...
proof -
  obtain N where support: "book_theory_retraction_support \<Omega> G S A N"
    using book_theory_derivable_retraction_support[where \<Omega>=\<Omega>, OF derivation] by (elim exE)
  have finite: "finite N" by (rule book_theory_retraction_support_finite[OF support])
  ...
  have retracted: "book_theory_derivable \<Omega> G (image (named_retract \<Omega> ?v) S) (named_retract \<Omega> ?v A)"
...
theorem book_theory_signature_conservativity:
  ...
  shows "book_theory_derivable \<Omega> G S A \<longleftrightarrow> book_theory_derivable \<Sigma> G S A"
proof
  assume derivation: "book_theory_derivable \<Omega> G S A"
  show "book_theory_derivable \<Sigma> G S A"
    by (rule book_theory_foreign_constants_eliminate[OF rich derivation conclusion_names premise_names])
next
  assume derivation: "book_theory_derivable \<Sigma> G S A"
  show "book_theory_derivable \<Omega> G S A" by (rule book_theory_signature_mono[OF derivation inclusion])
qed
