theory Bacon_Book_Finite_Image_Cover
  imports Bacon_Book_Theory_Signature_Conservativity Bacon_Book_Theory_Consistency
begin
...
proof (unfold book_theory_consistent_def, rule notI)
  ...
  have original: "book_theory_derivable \<Sigma> G S (book_bottom G)"
    by (rule book_theory_foreign_constants_eliminate[OF rich contradiction bottom_names names])
