theory Bacon_Book_Full_Classicism_Infinite_Witness_Family
  imports Bacon_Book_Full_Classicism_Finite_Witness_Family
    Bacon_Book_Environment_Development.Bacon_Book_Finite_Image_Cover
begin

lemma book_full_C_consistent_subset:
  assumes consistent: "book_full_C_theory_consistent \<Sigma> G S" and subset: "T \<subseteq> S"
  shows "book_full_C_theory_consistent \<Sigma> G T"
proof (unfold book_full_C_theory_consistent_def, rule notI)
  assume contradiction: "book_full_C_theory_derivable \<Sigma> G T (book_bottom G)"
  have lifted: "book_full_C_theory_derivable \<Sigma> G S (book_bottom G)"
    by (rule book_full_C_theory_derivable_mono[OF contradiction subset])
  show False using consistent lifted unfolding book_full_C_theory_consistent_def by contradiction
qed

section \<open>Arbitrary witness families with the full enlarged C retained\<close>

theorem book_full_C_consistent_witness_family:
  ...
  shows "book_full_C_theory_consistent (book_witness_family_signature \<Sigma> \<tau> c I) G
    (S \<union> book_witness_family_axioms G \<tau> F c I)"
proof (rule iffD2[OF book_full_C_theory_consistent_finite_character])
  ...
  show "\<forall>B. finite B \<longrightarrow> B \<subseteq> S \<union> book_witness_family_axioms G \<tau> F c I \<longrightarrow>
    book_full_C_theory_consistent ?full G B"
  proof (intro allI impI)
    ...
    have partial_consistent: "book_full_C_theory_consistent ?partial G ?P"
      by (rule book_full_C_consistent_finite_witness_family[where \<Sigma>=\<Sigma> and G=G and S=S
    ...
    have full_consistent: "book_full_C_theory_consistent ?full G ?P"
      by (rule book_full_C_theory_consistency_signature_preservation[OF rich partial_consistent partial_language])
    have subset: "B \<subseteq> ?P" using covered_J by (simp only: book_witness_family_axioms_def)
    show "book_full_C_theory_consistent ?full G B" by (rule book_full_C_consistent_subset[OF full_consistent subset])
  qed
qed
