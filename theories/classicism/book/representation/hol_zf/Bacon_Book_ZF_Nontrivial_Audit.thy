...
local
  val targets =
   [("every nontrivial world has actual typed assignments", "book_ZF_nontrivial_modal_model.typed_assignment_exists"),
    ...
    ("canonical reindexed domains are inhabited", "book_full_C_canonical_frame.full_ZF_reindexed_domains_nonempty"),
    ("each canonical reindexed world has a false proposition", "book_full_C_canonical_frame.full_ZF_reindexed_false_at_world"),
    ("the canonical model satisfies the explicit nontrivial refinement", "book_full_C_canonical_frame.full_ZF_canonical_nontrivial_modal_model"),
    ("fixed-ambient consistency constructs a nontrivial model", "book_countable_ambient_signature.book_full_C_ambient_nontrivial_modal_model_exists"),
  ...
  val report = "FOUNDATION: standard HOL-ZF; not pure HOL\n"
    ^ "SCOPE: explicit nontrivial-model refinement and actual canonical/countable-signature existence; not generic soundness or final completeness\n"
