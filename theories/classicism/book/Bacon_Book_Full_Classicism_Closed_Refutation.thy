theory Bacon_Book_Full_Classicism_Closed_Refutation
...
theorem book_full_C_theory_closed_refutation:
  assumes rich: "sg_rich G" and language: "book_theory_formula \<Sigma> G A"
    and closed: "named_fv A = {}"
    and contradiction: "book_full_C_theory_derivable \<Sigma> G (insert (book_not G A) S) (book_bottom G)"
...
proof -
  ...
  have base: "book_theory_derivable \<Sigma> G (insert (book_not G A) (?C \<union> S)) (book_bottom G)"
    using contradiction by (simp only: book_full_C_theory_derivable_def sets)
  show ?thesis unfolding book_full_C_theory_derivable_def
    by (rule book_theory_closed_refutation[OF rich language closed base])
qed

corollary book_full_C_theory_consistent_negative_extension:
  assumes rich: "sg_rich G" and language: "book_theory_formula \<Sigma> G A"
    and closed: "named_fv A = {}" and missing: "\<not> book_full_C_theory_derivable \<Sigma> G S A"
  shows "book_full_C_theory_consistent \<Sigma> G (insert (book_not G A) S)"
  using book_full_C_theory_closed_refutation[OF rich language closed] missing
