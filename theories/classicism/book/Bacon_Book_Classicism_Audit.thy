...
local
  val targets =
   [("native full-F book C proofs have book-language conclusions", "book_C_proves_language"),
    ...
    ("the transported Henkin signature stays inside the fixed countable ambient language", "book_ambient_signature.book_ambient_henkin_signature_inside"),
    ("the transported Henkin signature retains infinitely many ambient names at each type", "book_ambient_signature.book_ambient_henkin_signature_reserve"),
    ("actual C Henkin completion fixes old formulas inside a countable ambient language", "book_ambient_signature.book_C_ambient_henkin_extension_exists"),
