...
proof -
  show ?thesis unfolding book_ambient_henkin_signature_def
    by (rule book_full_C_henkin_image_extension_exists[OF rich language consistent book_ambient_name_map_injective
...
text \<open>
  The general ambient signature embedding is purely syntactic and
  is reused unchanged: Σσ ⊆ Ωσ ⊆ Bσ, old declared names are fixed,
  and Bσ − Ωσ remains infinite and at least as large as ⋃Ω. The consistency and maximal-extension
