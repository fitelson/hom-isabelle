theory Bacon_Book_Full_Classicism_Henkin_Extension
  imports Bacon_Book_Full_Classicism_Henkin_Union Bacon_Book_Full_Classicism_Universal_Closure
    Bacon_Book_Full_Classicism_Closed_Maximal
    Bacon_Book_Environment_Development.Bacon_Book_Closed_Henkin_Extension
begin

theorem book_full_C_henkin_closed_premises_consistent:
  ...
  shows "book_full_C_theory_consistent (book_henkin_full_signature \<Sigma> G) G (book_henkin_closed_premises \<Sigma> G S)"
proof -
  ...
  have full_consistent: "book_full_C_theory_consistent (book_henkin_full_signature \<Sigma> G) G (book_henkin_full_premises \<Sigma> G S)"
    by (rule book_full_C_henkin_full_premises_consistent[OF rich language consistent])
  show ?thesis using full_consistent
    by (simp only: book_henkin_closed_premises_def book_full_C_consistent_universal_closures[OF rich full_language])
qed

theorem book_full_C_closed_henkin_extension_exists:
  assumes rich: "sg_rich G" and language: "\<And>A. A \<in> S \<Longrightarrow> book_theory_formula \<Sigma> G A"
    and consistent: "book_full_C_theory_consistent \<Sigma> G S"
  shows "\<exists>M. book_full_C_closed_maximal_extension (book_henkin_full_signature \<Sigma> G) G
      (book_henkin_closed_premises \<Sigma> G S) M \<and>
    book_full_C_theory_consistent (book_henkin_full_signature \<Sigma> G) G M \<and>
...
proof -
  ...
  have consistent_P: "book_full_C_theory_consistent ?\<Omega> G ?P"
  ...
  obtain M where maximal: "book_full_C_closed_maximal_extension ?\<Omega> G ?P M"
    using book_full_C_closed_maximal_extension_exists[OF rich closed_P consistent_P] by blast
  ...
  have consistent_M: "book_full_C_theory_consistent ?\<Omega> G M" by (rule book_full_C_closed_maximal_consistent[OF rich maximal])
