theory Bacon_Book_Full_Classicism_Finite_Witness_Family
  imports Bacon_Book_Full_Classicism_Conditional_Witness
...
theorem book_full_C_consistent_finite_witness_family:
...
next
  ...
  have partial_consistent: "book_full_C_theory_consistent ?\<Omega> G ?P"
  ...
  have extended: "book_full_C_theory_consistent (book_add_constant ?\<Omega> (c i) (\<tau> i)) G
    (insert (book_witness_axiom G (\<tau> i) (F i) (c i)) ?P)"
    by (rule book_full_C_consistent_conditional_witness[
