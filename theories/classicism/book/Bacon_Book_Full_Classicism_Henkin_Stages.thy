theory Bacon_Book_Full_Classicism_Henkin_Stages
  imports Bacon_Book_Full_Classicism_Infinite_Witness_Family Bacon_Book_Full_Classicism_Uniform_Name_Map
...
theorem book_full_C_henkin_stage_consistent:
  assumes rich: "sg_rich G"
    and consistent: "book_full_C_theory_consistent (book_henkin_signature \<Sigma> G n) G S"
    and language: "\<And>A. A \<in> S \<Longrightarrow>
      book_theory_formula (book_henkin_signature \<Sigma> G n) G A"
  shows "book_full_C_theory_consistent (book_henkin_signature \<Sigma> G (Suc n)) G
...
proof -
  ...
  have family: "book_full_C_theory_consistent
      (book_witness_family_signature (book_henkin_signature \<Sigma> G n) fst ?c ?I) G
      (S \<union> book_witness_family_axioms G fst snd ?c ?I)"
    by (rule book_full_C_consistent_witness_family[where \<Sigma>="book_henkin_signature \<Sigma> G n"
...
theorem book_full_C_henkin_premises_consistent:
  assumes rich: "sg_rich G"
  ...
  shows "book_full_C_theory_consistent (book_henkin_signature \<Sigma> G n) G (book_henkin_premises \<Sigma> G S n)"
proof (induction n rule: nat.induct[case_names zero Suc])
  case zero
  have initial: "book_full_C_theory_consistent (\<lambda>\<tau>. BookOriginal ` \<Sigma> \<tau>) G (book_constant_rename BookOriginal ` S)"
    by (rule iffD1[OF book_full_C_consistent_constant_rename_iff[
...
next
  ...
  have next_stage: "book_full_C_theory_consistent (book_henkin_signature \<Sigma> G (Suc n)) G
    (book_henkin_premises \<Sigma> G S n \<union> book_henkin_stage_axioms \<Sigma> G n)"
    by (rule book_full_C_henkin_stage_consistent[where \<Sigma>=\<Sigma> and G=G and n=n
